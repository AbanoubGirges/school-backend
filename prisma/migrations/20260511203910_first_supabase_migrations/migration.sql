/*
  ...
  - You are about to drop the column `profilePicturePath` on the `User` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "User" DROP COLUMN "profilePicturePath",
